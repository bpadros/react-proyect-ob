...
const TaskForm = ({add ,length}) => {
    ...
    return (
        ...
        {/* <label htmlFor='select-level' className='sr-only'></label> */}
        <select  className='form-control form-control-lg' ref={levelRef} defaultValue={LEVELS.NORMAL} id='select-level'>
